 ...
 */
angular.module('AdminApp').service('resultService', function ($q, $http) {
    ...
    this.getUserWageSummary = function (groupId) {
        var deferred = $q.defer();
        $http.get('report/user/wage_summary/groupid/' + groupId).success(function (data) {
            deferred.resolve(data);
        });
        return deferred.promise;
    }
