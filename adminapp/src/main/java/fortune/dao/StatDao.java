...
public class StatDao {
    ...
    public List<LotteryMarkSixUserStat> getLotteryMarkSixUserStatList(String userId, String groupid, String start, String end) {
        return sessionFactory.getCurrentSession().createQuery(String.format("from LotteryMarkSixUserStat where userId='%s' and groupId='%s' and openTs >= '%s' and openTs <='%s' order by issue desc", userId, groupid, start, end)).list();
